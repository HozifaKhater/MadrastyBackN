...
namespace API.Controllers
{
    ...
    [ApiController]
    public class SpeakingDisorderDetailsFirstController : ControllerBase
    {
        private readonly ISpeakingDisorderDetailsFirstService _service;

        public SpeakingDisorderDetailsFirstController(ISpeakingDisorderDetailsFirstService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Save([FromBody] SpeakingDisorderDetailsFirst model)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody] SpeakingDisorderDetailsFirst model)
        {
            if (ModelState.IsValid)
            {
